export const TEST_COURSE = {
  ...
  features: [
    ...
    // Start
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [18.161345832564905, 59.28992782384871],
      },
    ...
    // Control 1
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [18.167132635232818, 59.289336641852344],
      },
    ...
    // Control 2
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [18.159692935372995, 59.2862579140567],
      },
    ...
    // The Finish
    {
      ...
      geometry: {
        type: 'Point',
        coordinates: [18.156246529926673, 59.29060978989479],
      },
